...
export default function Tetris(props) {
    var _a;
    var _b = React.useReducer(Game.update, Game.init(props.matrix)), game = _b[0], dispatch = _b[1];
    ...
    var controller = React.useMemo(function () { return ({
        ...
        hardDrop: function () { return props.onHardDrop; },
        moveDown: function () { return props.onMoveDown; },
        moveLeft: function () { return props.onMoveLeft; },
        moveRight: function () { return props.onMoveRight; },

...
export var update = function (game, inputAction) {
    var _a, _b;
    var action = typeof inputAction === 'string' ? { type: inputAction } : inputAction;
    switch (action.type) {
        case 'RESTART': {
            return init();
        }
        ...
        case 'REPLACE_GAME':
            return __assign(__assign({}, game), action.game);
        default: {
...
export var init = function (startMatrix) {
    ...
    return {
        ...
        points: 0,
        lines: 0,
        matrix: startMatrix !== null && startMatrix !== void 0 ? startMatrix : buildMatrix(),
